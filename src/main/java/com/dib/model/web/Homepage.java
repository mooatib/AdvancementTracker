...
public class Homepage {
        ...
        for (PlayerAdvancement player : playerAdvancements.values()) {
            ...
            for (PlayerAdvancementProgress advancement : player.getAdvancements().values()) {
                if (advancement.completed()) {
                    String name = advancement.metadata().title();
                    String description = advancement.metadata().description();
                    String badgeClass = "advancement-badge";
                    String iconName = advancement.metadata().iconName();
                    String icon = "<img src=\"" + texturePath(iconName) + "\" alt=\" \" width=\"32\" height=\"32\">";

                    html.append("                        <div class=\"").append(badgeClass).append("\">\n");
                    html.append("                            ").append(icon).append(name).append("\n");
    ...
    private static String texturePath(String iconName) {
